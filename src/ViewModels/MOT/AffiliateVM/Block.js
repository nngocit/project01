...
@inject(HttpClient, ObserverLocator, BindingEngine, BizProductsService,LogService)
export class UpdateMapVnpVM {
    ...
    //test
    constructor(http, observerLocator, bindingEngine, bizProductsService,logService) {
    ...
    updateMapVnp() {
        ...
        this.bizProductsService.InsertSponsorProdcut(objToPost).then((rs) => {
            if (rs.Result) {
                this.logService.InsertAdminCPLog("Affiliate | San pham ban chay | InsertSponsorProdcut",rs.Result, JSON.stringify(objToPost));    
                toastr.success('Cập nhật thành công');
            } else {
                this.logService.InsertAdminCPLog("Affiliate | San pham ban chay | InsertSponsorProdcut",'Cập nhật không thành công', JSON.stringify(objToPost));    
