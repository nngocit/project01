...
export class AddCampaign {
    ...
    submitBusiness() {
        ...
        this.bizProductsService.SubmitBusinessCampaign(jsonToPost).then((data) => {
            if (data.Result == true) {
                this.logService.InsertAdminCPLog("Affiliate | Quan ly doi Tac | AddBusiness",data.Result, JSON.stringify(jsonToPost));
                ...
                this.logService.InsertAdminCPLog("Affiliate | Quan ly doi Tac | DelBusiness","false", JSON.stringify(jsonToPost));
