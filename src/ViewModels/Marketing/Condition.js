    ...
    SubmitCondition() {
        ...
        this.quaySoService.InsertOrUpdateQuaySoCondition(jsonToPost).then((data) => {
            if (data.Result == true) {
                ...
                this.logService.InsertAdminCPLog("Marketing | Cau Hinh Dieu Kien Quay", this.isEdit === false ? 'Tạo mới Điều kiện quay thành công!' : 'Cập nhật Điều kiện quay thành công!', JSON.stringify(this.ListConditions));
