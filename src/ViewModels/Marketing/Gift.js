    ...
    SubmitGift() {
        ...
        this.quaySoService.InsertOrUpdateQuaySoGift(jsonToPost).then((data) => {
            if (data.Result == true) {
                ...
                this.logService.InsertAdminCPLog("Marketing | CauHinhQuaTang",this.isEdit === false ? 'Tạo mới gift thành công!' : 'Cập nhật gift thành công!', JSON.stringify(this.ListGifts));    
