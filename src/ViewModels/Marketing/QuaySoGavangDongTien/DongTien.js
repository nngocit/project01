...
export class Gavang {
    ...
    Danhsachkhachhangtheotuan3() {
        //  console.log(this.objQua3());
        this.quaySoResult3 = '000000000000000';
        this.webQuaySoService.GetListKhachHangTrungGaVangDongTien(this.objQua3()).then(rs => {
            if (rs.StatusCode == "InvalidData") {

                this.DSKhachHangTrung3 = rs.Data.DsKhachhangsDaTrung;
                this.total = 0;
            } else {
                this.DSKhachHangTrung3 = rs.Data.DsKhachhangsDaTrung;
                this.total = this.DSKhachHangTrung3.length;
            }
    ...
    KetQua1() {
        this.webQuaySoService.GetKhachHangTrungGaVangDongTien(this.objQua1()).then(rs => {
            ...
            if (rs.StatusCode == "Success") {
                ...
                this.logService.InsertAdminCPLog("ĐỒNG TIỀN OPPO", rs.StatusCode, JSON.stringify(rs));
                this.DSKhachHangTrung1 = rs.Data.DsKhachhangsDaTrung;
                this.total = this.DSKhachHangTrung1.length;
                ...
                swal({ title: "QUAY SỐ ĐỒNG TIỀN OPPO", text: "Chưa Lấy được kết quả hoặc hết quà!", type: "warning", timer: 5000 });
                this.quaySoResult = '000000000000000';
                this.total = this.DSKhachHangTrung1.length;
            }
    ...
    KetQua2() {
        this.webQuaySoService.GetKhachHangTrungGaVangDongTien(this.objQua2()).then(rs => {
            ...
            if (rs.StatusCode == "Success") {
                ...
                this.logService.InsertAdminCPLog("ĐỒNG TIỀN APPLE", rs.StatusCode, JSON.stringify(rs));
                this.DSKhachHangTrung2 = rs.Data.DsKhachhangsDaTrung;
                this.total = this.DSKhachHangTrung2.length;
                ...
                this.logService.InsertAdminCPLog("QuaySoGaVang", rs.StatusCode, JSON.stringify(rs));
                swal({ title: "QUAY SỐ ĐỒNG TIỀN APPLE", text: "Chưa Lấy được kết quả hoặc hết quà!", type: "warning", timer: 5000 });
                this.quaySoResult2 = '000000000000000';
                this.total = this.DSKhachHangTrung2.length;
            }
    ...
    KetQua3() {
        this.webQuaySoService.GetKhachHangTrungGaVangDongTien(this.objQua3()).then(rs => {
            //  console.log(JSON.stringify(rs));
            if (rs.StatusCode == "Success") {
                ...
                this.logService.InsertAdminCPLog("ĐỒNG TIỀN LAPTOP", rs.StatusCode, JSON.stringify(rs));
                this.DSKhachHangTrung3 = rs.Data.DsKhachhangsDaTrung;
                this.total = this.DSKhachHangTrung3.length;
                ...
                this.logService.InsertAdminCPLog("QuaySoGaVang", rs.StatusCode, JSON.stringify(rs));
                swal({ title: "QUAY SỐ ĐỒNG TIỀN LAPTOP", text: "Chưa Lấy được kết quả hoặc hết quà!", type: "warning", timer: 5000 });
                this.quaySoResult3 = '000000000000000';
                this.total = this.DSKhachHangTrung3.length;
            }
