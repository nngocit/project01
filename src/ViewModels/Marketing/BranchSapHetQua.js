...
@inject(QuaySoService, ExcelService, QuaySoPermission,LogService)
export class BranchSapHetQua {
    ...
    constructor(quaySoService, excelService, quaySoPermission,logService) {
    ...
    async DownloadReport() {
        ...
        if (response != null) {
            ...
            this.logService.InsertAdminCPLog("Marketing | BranchSapHetQua",'Export!','Xuất báo cáo thành công!');
            toastr.success("Xuất báo cáo thành công!", "Thành công");

        } else
             this.logService.InsertAdminCPLog("Marketing | BranchSapHetQua",'Export!','Không có dữ liệu để xuất báo cáo!');
