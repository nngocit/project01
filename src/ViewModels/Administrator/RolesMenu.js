        ...
        if (this.isEdit === false) {
            this.userService.InsertRoles(jsonToPost).then((data) => {
                if (data.Result == true) {
                    ...
                    this.logService.InsertAdminCPLog("Administrator | Rolemenunew",'Tạo mới roles thành công!',JSON.stringify(jsonToPost));
                    toastr.success('Tạo mới roles thành công!', 'Quản lý Roles');
                    return true;
                } else {
                    this.logService.InsertAdminCPLog("Administrator | Rolemenunew",'Lỗi! Xin thử lại!',JSON.stringify(jsonToPost));
            ...
            if (this.currentDNMenu.ListRole != null) {
                ...
                this.userService.InsertMenu(jsonToPost).then((data) => {
                    if (data.Result == true) {
                        ...
                        this.logService.InsertAdminCPLog("Administrator | Rolemenunew",'Tạo mới menu thành công!',JSON.stringify(jsonToPost));
                        toastr.success('Tạo mới menu thành công!', 'Quản lý menu');
                        return true;
                    } else {
                        this.logService.InsertAdminCPLog("Administrator | Rolemenunew",'Tạo mới menu không thành công!',JSON.stringify(jsonToPost));
                        toastr.error("Lỗi! Xin thử lại!");
                        return false;
                    }
                });
