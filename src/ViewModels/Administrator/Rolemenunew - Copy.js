...
import { Viewrolenewactiondlg } from './Viewrolenewactiondlg';
@inject(UserService)
export class RolesMenu {
    ...
    constructor(userService) {
        ...
        // this.currentphanquyenuser = 1;
        // this.currentaction = 1;
        

        // this.itemperpage = 10;
        // this.itemperpagemenucap1 = 10;
        // this.itemperphanquyenuser = 10;
        // this.itemperaction = 10;

        // this.total1 = 100;
        // this.currentmenucap1 = 1;
        
        // this.pagesize1 = 2;
        // this.pagesizemenucap1 = 8;
        // this.pagesizephanquyenuser = 8;
        // this.pagesizeaction = 8;

        // this.selectedCompany = 1;
        // this.filterCompany = "";
        // this.UsernamePage = 300;
        // this.total2 = 100;
         this.total = 0;
    ...
    activate() {
        ...
        this.userService.GetListUserByCompanyIdPassed(this.selectedCompany)]).then((rs) => {
            ...
            this.total = this.ListDN3.length;
            console.log('this.ListDN3.length',this.ListDN3.length);
