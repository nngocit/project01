...
///Using for call API from WebComment
@transient()
@inject(NewInstance.of(HttpClient), HttpServiceHelpers)
export class HttpServiceWebComment {
    constructor(http, httpServiceHelpers) {
        http.configure(config => {
            config
                .useStandardConfiguration()
                .withBaseUrl(APISettings.Webcomment)
        });
        this.http = http;
        this.httpInstance = http;
        this.httpServiceHelpers = httpServiceHelpers;
...
///Using for call API from GiaoDichOnline
@transient()
@inject(NewInstance.of(HttpClient), HttpServiceHelpers)
export class HttpServicegiaodichOnline {
    constructor(http, httpServiceHelpers) {
        http.configure(config => {
            config
                .useStandardConfiguration()
                .withBaseUrl(APISettings.GiaoDichOnline)
        });
        this.http = http;
        this.httpInstance = http;
        this.httpServiceHelpers = httpServiceHelpers;
...
@transient()
@inject(NewInstance.of(HttpClient), HttpServiceHelpers)
export class HttpServicePushNotification {
    constructor(http, httpServiceHelpers) {
        http.configure(config => {
            config
                .useStandardConfiguration()
                .withBaseUrl(APISettings.PushNotificationApi)
        });
        this.http = http;
        this.httpInstance = http;
        this.httpServiceHelpers = httpServiceHelpers;
