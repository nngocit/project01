...
@inject(HttpService, LogService, AppState)
@transient()
export class UserService {

    constructor(httpService, logService, appState) {
    ...
    LogIn(jsonToPost) {
        ...
        this.logService.InsertAdminCPLog("VTA APP | LogIn from User Service", jsonToPost, "");
        return this.httpService.GetData(APISettings.APILogIn, 'post', jsonToPost);
    }

    LogOut(UserId) {
        //console.log(jsonToPost);
        this.logService.InsertAdminCPLog("VTA APP | LogOut from User Service", UserId, "");
        return this.httpService.GetData(APISettings.APILogOut + "?UserId=" + UserId, 'get', null);
    }
