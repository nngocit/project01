...
(function(process) {
  ...
  gulp.task('css', function() {
    ...
    return gulp.src(paths.css).pipe(plug.bytediff.start()).pipe(plug.minifyCss({})).pipe(plug.bytediff.stop(bytediffFormatter)).pipe(plug.rename('toastr.min.css')).pipe(gulp.dest(paths.build));
  });
