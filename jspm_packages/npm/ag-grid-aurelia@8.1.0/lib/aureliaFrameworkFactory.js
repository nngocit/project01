...
var AureliaFrameworkFactory = (function() {
  function AureliaFrameworkFactory(_componentFactory, _viewCompiler) {
    ...
    this._baseFrameworkFactory = new main_1.BaseFrameworkFactory();
  }
...
AureliaFrameworkFactory = __decorate([aurelia_framework_1.autoinject(), aurelia_framework_1.transient(), __metadata("design:paramtypes", [aureliaComponentFactory_1.AureliaComponentFactory, aurelia_framework_1.ViewCompiler])], AureliaFrameworkFactory);
