...
(function(process) {
    ...
    window.CKEDITOR && window.CKEDITOR.dom || (window.CKEDITOR || (window.CKEDITOR = function() {
        ...
        on: function(b, e, f, l, d) {
          ...
          if (0 > g.getListenerIndex(e)) {
            ...
            for (var v = g.length - 1; 0 <= v; v--)
              if (g[v].priority <= d)
                return g.splice(v + 1, 0, h), {removeListener: k};
            g.unshift(h);
          }
      ...
      if (window.console && window.console.log) {
        ...
        if (a = a.data.additionalData)
          ...
          console[f]("[CKEDITOR] Error code: " + b + ".");
      ...
      CKEDITOR.tools = {
        ...
        buildStyleHtml: function(a) {
          ...
          for (var g,
              ...
              b = 0; b < a.length; b++)
            if (g = a[b])
              /@import|[{}]/.test(g) ? d.push("\x3cstyle\x3e" + g + "\x3c/style\x3e") : d.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + g + '"\x3e');
          return d.join("");
        },
        ...
        normalizeHex: function(a) {
          return a.replace(/#(([0-9a-f]{3}){1,2})($|;|\s+)/gi, function(a, d, b, k) {
            a = d.toLowerCase();
        ...
        getCookie: function(a) {
          ...
          for (var g = document.cookie.split(";"),
              ...
              b,
              h = 0; h < g.length; h++)
            if (d = g[h].split("\x3d"), b = decodeURIComponent(CKEDITOR.tools.trim(d[0]).toLowerCase()), b === a)
      ...
      var a = CKEDITOR.tools.extend,
          f = function(a, g) {
            for (var d = CKEDITOR.tools.clone(a),
      ...
      getIndex: function(a) {
        ...
        var c = this.$,
            e = -1,
            m;
        if (!this.$.parentNode || a && c.nodeType == CKEDITOR.NODE_TEXT && b(c) && !f(c) && !f(c, !0))
          return -1;
        do
 ...
 while (f = f.getParent());
      ...
      getPosition: function(a) {
        ...
        if (f.compareDocumentPosition)
          return f.compareDocumentPosition(b);
        if (f == b)
        ...
        if (this.type == CKEDITOR.NODE_ELEMENT && a.type == CKEDITOR.NODE_ELEMENT) {
          ...
          if ("sourceIndex" in f)
            return 0 > f.sourceIndex || 0 > b.sourceIndex ? CKEDITOR.POSITION_DISCONNECTED : f.sourceIndex < b.sourceIndex ? CKEDITOR.POSITION_PRECEDING : CKEDITOR.POSITION_FOLLOWING;
        }
        f = this.getAddress();
        a = a.getAddress();
        for (var b = Math.min(f.length, a.length),
            c = 0; c < b; c++)
          if (f[c] != a[c])
            return f[c] < a[c] ? CKEDITOR.POSITION_PRECEDING : CKEDITOR.POSITION_FOLLOWING;
        ...
        for (var a; this.getFirst && (a = this.getFirst()); ) {
          if (a.type == CKEDITOR.NODE_TEXT) {
            var f = CKEDITOR.tools.ltrim(a.getText()),
                b = a.getLength();
            if (f)
              f.length < b && (a.split(b - f.length), this.$.removeChild(this.$.firstChild));
            else {
              a.remove();
              continue;
            }
        ...
        for (var a; this.getLast && (a = this.getLast()); ) {
          if (a.type == CKEDITOR.NODE_TEXT) {
            var f = CKEDITOR.tools.rtrim(a.getText()),
                b = a.getLength();
            if (f)
              f.length < b && (a.split(f.length), this.$.lastChild.parentNode.removeChild(this.$.lastChild));
            else {
              a.remove();
              continue;
            }
      ...
      CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
        ...
        isEmptyInlineRemoveable: function() {
          ...
          for (var a = this.getChildren(),
            ...
            if (g.type != CKEDITOR.NODE_ELEMENT || !g.data("cke-bookmark"))
              if (g.type == CKEDITOR.NODE_ELEMENT && !g.isEmptyInlineRemoveable() || g.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(g.getText()))
                return !1;
          }
          return !0;
        },
          ...
          function a(b, d, g) {
            if (d && d.type == CKEDITOR.NODE_ELEMENT) {
              for (var c = []; d.data("cke-bookmark") || d.isEmptyInlineRemoveable(); )
                if (c.push(d), d = g ? d.getNext() : d.getPrevious(), !d || d.type != CKEDITOR.NODE_ELEMENT)
                  return;
              if (b.isIdentical(d)) {
        ...
        getDocumentPosition: function(a) {
          ...
          if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ? 8 !== CKEDITOR.env.version : 1)) {
            ...
            for (p = this, q = null; p && "body" != p.getName() && "html" != p.getName(); ) {
 ...
 while (b = b.getParent());
          ...
          for (var g = 0; g < c.length; g++) {
            ...
            if (!(f in b))
              if ("checked" == f && (m = this.getAttribute(f)))
                ...
                m = this.getAttribute(f), null === m && (m = e.nodeValue), a.setAttribute(f, m);
          }
        ...
        getEditor: function(a) {
          ...
          a = a || void 0 === a;
          for (c in b)
            if (g = b[c], g.element.equals(this) && g.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO || !a && (e = g.editable()) && (e.equals(this) || e.contains(this)))
              return g;
          return null;
        },
        find: function(a) {
 ...
 while (h(a));
      ...
      function f(a, b, c, d, e) {
        ...
        var y = a.startContainer,
            ...
            H,
            K;
        if (u && C.type == CKEDITOR.NODE_TEXT && y.equals(C))
          y = a.document.createText(y.substring(x, B)), c.append(y);
        else {
        ...
        createBookmark2: function() {
          function a(b) {
            ...
            if (g.type == CKEDITOR.NODE_TEXT) {
              e = g;
              for (k = 0; (e = e.getPrevious()) && e.type == CKEDITOR.NODE_TEXT; )
                k += e.getText().replace(CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE, "").length;
              e = k;
          ...
          switch (a) {
            ...
            case CKEDITOR.ENLARGE_ELEMENT:
              ...
              for (u = c(u); u || y; ) {
                if (u && !y) {
                  !C && u.equals(f) && (C = !0);
                  if (e ? u.isBlockBoundary() : !h.contains(u))
                    break;
                  x && "inline" == u.getComputedStyle("display") || (x = !1, C ? m = u : this.setStartBefore(u));
                  y = u.getPrevious();
                }
                for (; y; )
                  if (B = !1, y.type == CKEDITOR.NODE_COMMENT)
                    y = y.getPrevious();
                  else {
                    if (y.type == CKEDITOR.NODE_TEXT)
                      D = y.getText(), d.test(D) && (y = null), B = /[\s\ufeff]$/.test(D);
                    else if ((y.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && y.is("br")) && !y.data("cke-bookmark"))
                      if (x && CKEDITOR.dtd.$removeEmpty[y.getName()]) {
                        D = y.getText();
                        if (d.test(D))
                          y = null;
                        else
                          for (var F = y.$.getElementsByTagName("*"),
                              G = 0,
                              I; I = F[G++]; )
              ...
              for (; u || y; ) {
                ...
                for (; y; ) {
                  B = !1;
                  if (y.type == CKEDITOR.NODE_TEXT)
                    D = y.getText(), k(y, 0) || (y = null), B = /^[\s\ufeff]/.test(D);
                  else if (y.type == CKEDITOR.NODE_ELEMENT) {
                    if ((0 < y.$.offsetWidth || b && y.is("br")) && !y.data("cke-bookmark"))
                      if (x && CKEDITOR.dtd.$removeEmpty[y.getName()]) {
                        D = y.getText();
                        if (d.test(D))
                          y = null;
            ...
            case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
              ...
              if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                ...
                if ((u = u.previous()) && u.type == CKEDITOR.NODE_ELEMENT && u.is("br"))
                  break;
              }
              u = this.clone();
              u.collapse();
        ...
        shrink: function(a, b, c) {
          if (!this.collapsed) {
            ...
            d.guard = function(b, d) {
              if (u(b))
                return !0;
              if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(y) || !1 === c && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable"))
                return !1;
        ...
        removeEmptyBlocksAtEnd: function() {
          ...
          return function(b) {
            for (var c = this.createBookmark(),
                ...
                k; e && !e.equals(d.root) && !e.getFirst(a(e)); )
              k = e.getParent(), this[b ? "setEndAt" : "setStartAt"](e, CKEDITOR.POSITION_AFTER_END), e.remove(1), e = k;
            this.moveToBookmark(c);
          };
        }(),
        startPath: function() {
          ...
          if (c && c.find)
            for (f = c.find(a), k = 0; k < f.count(); k++)
              if (c = f.getItem(k), b || !c.isReadOnly())
                h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), m = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED, h && m && e.push(c);
          return e;
        }
      };
        ...
        getNextParagraph: function(a) {
          ...
          if (this._.nestedEditable) {
            if (g = this._.nestedEditable.iterator.getNextParagraph(a))
              return this.activeFilter = this._.nestedEditable.iterator.activeFilter, g;
          ...
          for (this._.nextNode = null; q; ) {
            var r = 0,
                ...
                u = 0;
            if (A)
              q.type == CKEDITOR.NODE_TEXT && e.test(q.getText()) && (A = 0);
            else {
              var y = q.getName();
      ...
      function a(a, b, c, d, e) {
        ...
        for (g in b) {
          ...
          for (u in K) {
            ...
            y ? n = !1 : y = {};
            for (E in q)
              "!" == E.charAt(0) && (E = E.slice(1), C.push(E), y[E] = !0, n = !1);
            for (; E = C.pop(); )
              q[E] = q["!" + E], delete q["!" + E];
            m[p] = (n ? !1 : y) || null;
          }
        ...
        for (d = a.length; c < d; ++c) {
          ...
          for (u in J) {
            ...
            q = void 0;
            for (q in p)
              -1 < q.indexOf("*") ? y.push(new RegExp("^" + q.replace(/\*/g, ".*") + "$")) : y.push(q);
            p = y;
            p.length && (k[h] = p, m = !1);
          }
          k.nothingRequired = m;
      ...
      function l(a, b) {
        ...
        if (!0 === a)
          return a;
        if ("string" == typeof a)
          return a = I(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b));
        if (CKEDITOR.tools.isArray(a))
        ...
        if (e = a.requiredClasses)
          for (g = b.classes, c = 0; c < e.length; ++c)
            if (d = e[c], "string" == typeof d) {
              if (-1 == CKEDITOR.tools.indexOf(g, d))
                return !1;
      ...
      function t(a, b, d, e) {
        ...
        if (e.doFilter) {
          ...
          if (!a.allAttributes)
            for (J in h)
              C[J] || (t.test(J) ? J == (z = J.replace(/^data-cke-saved-/, "")) || C[z] || (delete h[J], r = !0) : (delete h[J], r = !0));
          if (!a.allStyles || a.hadInvalidStyle) {
            for (J in E)
              a.allStyles || n[J] ? w.push(J + ":" + E[J]) : r = !0;
            w.length && (h.style = w.sort().join("; "));
          } else
            x && (h.style = x);
          if (!a.allClasses || a.hadInvalidClass) {
            for (J = 0; J < u.length; ++J)
              (a.allClasses || k[u[J]]) && l.push(u[J]);
            l.length && (h["class"] = l.sort().join(" "));
            m && l.length < m.split(/\s+/).length && (r = !0);
          } else
            m && (h["class"] = m);
          r && (g = 1);
          if (!e.skipFinalValidation && !q(b))
            return d.push(b), 1;
        }
      ...
      function u(a, b, c) {
        ...
        if (F.$empty[d] || !a.children.length)
          "hr" == d && "br" == b ? a.replaceWith(z()) : (a.parent && c.push({
            check: "it",
            el: a.parent
          }), a.remove());
        else if (F.$block[d] || "tr" == d)
          if ("br" == b)
            a.previous && !A(a.previous) && (b = z(), b.insertBefore(a)), a.next && !A(a.next) && (b = z(), b.insertAfter(a)), a.replaceWithChildren();
          else {
            var d = a.children,
                e;
            b: {
            ...
            if (e)
              ...
              for (var g = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name,
                  ...
                  u,
                  k = d.length; 0 < k; )
                f = d[--k], g && (f.type == CKEDITOR.NODE_TEXT || f.type == CKEDITOR.NODE_ELEMENT && F.$inline[f.name]) ? (h || (h = new CKEDITOR.htmlParser.element(b), h.insertAfter(a), c.push({
                  check: "parent-down",
                  el: h
      ...
      function C(a, b) {
        ...
        for (g in d)
          if ("class" == g)
            for (c = d[g].split(/\s+/), f = a.classes.join("|"); h = c.pop(); ) {
              if (-1 == f.indexOf(h))
                return !1;
            }
      ...
      CKEDITOR.filter.prototype = {
        ...
        applyTo: function(a, b, c, d) {
              ...
              a: {
                ...
                if (k)
                  for (l = 0; l < k.length; ++l)
                    if ((p = d.match(k[l])) && p[0].length == d.length) {
                      c = !0;
                      break a;
                    }
          ...
          for (; l = a.pop(); )
            if (c = l.el, c.parent)
              switch (p = F[c.parent.name] || F.span, l.check) {
                case "it":
          ...
          if (!this.disabled && a) {
            ...
            for (e = 0; e < a.length; ++e) {
              ...
              for (k = 0; k < b.length; ++k)
                f = b[k], "string" == typeof f ? (f = f.split(/\s*:\s*/), h = f[0], u = null, m = f[1]) : (h = f.check, u = f.left, m = f.right), g || (g = f, g = g.element ? g.element : h ? h.match(/^([a-z0-9]+)/i)[0] : g.left.getDefinition().element), u instanceof CKEDITOR.style && (u = B(u)), c.push({
                  check: h == g ? null : h,
                  left: u,
        ...
        check: function(a, b, c) {
          ...
          if ("string" == typeof a) {
            ...
            d = a.getDefinition(), e = d.styles, h = d.attributes || {}, e && !CKEDITOR.tools.isEmpty(e) ? (e = G(e), h.style = CKEDITOR.tools.writeCssText(e, !0)) : e = {}, e = {
              name: d.element,
              attributes: h,
      ...
      M = CKEDITOR.filter.transformationsTools = {
        ...
        transform: function(a, b) {
          if ("string" == typeof b)
            ...
            for (g in e)
              if ("class" == g)
                for (c = a.classes.join("|"), k = e[g].split(/\s+/); h = k.pop(); )
                    ...
                    if (!(1 < d.length)) {
                      ...
                      c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? e.$.onreadystatechange = function() {
                        if ("loaded" == e.$.readyState || "complete" == e.$.readyState)
                          e.$.onreadystatechange = null, v(b, !0);
                      } : (e.$.onload = function() {
                        setTimeout(function() {
                          v(b, !0);
                        }, 0);
            ...
            l = function(b) {
              a.call(this, b, function(a) {
                ...
                for (d in a) {
                  ...
                  if (!f[d]) {
                    if (n.icons)
                      for (var t = n.icons.split(","),
                          w = t.length; w--; )
                        CKEDITOR.skin.addIcon(t[w], n.path + "icons/" + (CKEDITOR.env.hidpi && n.hidpi ? "hidpi/" : "") + t[w] + ".png");
                    f[d] = 1;
                  }
                  if (v)
                    for (v.split && (v = v.split(",")), n = 0; n < v.length; n++)
                      m[v[n]] || b.push(v[n]);
                }
                if (b.length)
                  l.call(this, b);
 ...
 while (CKEDITOR.instances[a]);
      ...
      function n(a) {
        var b = a.config,
            ...
            e = b.removePlugins;
        if (d)
          var g = new RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"),
              c = c.replace(g, ""),
              c = c + ("," + d);
        if (e)
          var f = new RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"),
              c = c.replace(f, "");
      ...
      CKEDITOR.htmlParser.prototype = {
        ...
        parse: function(b) {
          ...
          if (b.length > m)
            this.onText(b.substring(m, b.length));
        }
      };
      ...
      CKEDITOR.htmlParser.fragment.fromHtml = function(m, l, d) {
        ...
        w.onTagOpen = function(d, e, g, m) {
          ...
          if (a(e))
            ...
            if ("br" == d)
              ...
              for (; !(m = (g = z.name) ? CKEDITOR.dtd[g] || (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || z.isUnknown || m[d]); )
                if (z.isOptionalClose)
                  w.onTagClose(g);
                else if (d in b && g in b)
                  g = z.children, (g = g[g.length - 1]) && "li" == g.name || n(g = new CKEDITOR.htmlParser.element("li"), z), !e.returnPoint && (e.returnPoint = z), z = g;
                else if (d in CKEDITOR.dtd.$listItem && !t(d, g))
                  w.onTagOpen("li" == d ? "ul" : "dl", {}, 0, 1);
                else if (g in f && !t(d, g))
                  !e.returnPoint && (e.returnPoint = z), z = z.parent;
                else if (g in CKEDITOR.dtd.$inline && q.unshift(z), z.parent)
                  n(z, z.parent, 1);
                else {
                  e.isOrphan = 1;
                  break;
        ...
        w.onText = function(a) {
          if (!(z._.hasInlineStarted && !r.length || u || A) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length))
            return;
          var b = z.name,
              g = b ? CKEDITOR.dtd[b] || (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
          if (!A && !g["#"] && b in f)
            w.onTagOpen(e[b] || ""), w.onText(a);
          else {
            k();
            h();
            u || A || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
      ...
      function f(b, c, e, f) {
        var l,
            d;
        for (l in c)
          (d = b[l]) || (d = b[l] = new a), d.add(c[l], e, f);
      }
      CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
        ...
        proto: {
          ...
          onElement: function(a, c) {
            for (var e = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$],
                f,
                l = 0; 3 > l; l++)
              if (f = e[l]) {
                f = f.exec(a, c, this);
      ...
      a.prototype = {
        ...
        findIndex: function(a) {
          for (var c = this.rules,
              e = c.length - 1; 0 <= e && a < c[e].priority; )
            e--;
          return e + 1;
        },
        exec: function(a, c) {
          var e = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
              ...
              n;
          for (n = 0; n < d; n++)
            if (e && (h = c.type, k = c.name), g = l[n], !(a.nonEditable && !g.options.applyToAll || a.nestedEditable && g.options.excludeNestedEditable)) {
      ...
      function a(a, d) {
            ...
            if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
              ...
              if (h)
                for (k(h, 1) && f.push(h); h; )
                  m(h) && (u = c(h)) && k(u) && ((l = c(u)) && !m(l) ? f.push(u) : (g(y).insertAfter(u), u.remove())), h = h.previous;
              for (h = 0; h < f.length; h++)
                f[h].remove();
              if (f = !a || !1 !== ("function" == typeof d ? d(e) : d))
                y || CKEDITOR.env.needsBrFiller || e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? y || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem) ? (f = b(e), f = !f || "form" == e.name && "input" == f.name) : f = !1 : f = !1;
              f && e.add(g(a));
            }
          };
        }
        function k(a, b) {
          if ((!y || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT && "br" == a.name && !a.attributes["data-cke-eol"])
            return !0;
          var c;
        ...
        for (E in n)
          "#" in z[E] || delete n[E];
        for (E in n)
          h.elements[E] = f(y, a.config.fillEmptyBlocks);
        h.root = f(y, !1);
      ...
      var q = /(?:&nbsp;|\xa0)$/,
          ...
          C = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]},
          x = {elements: {
              embed: function(a) {
                var b = a.parent;
                if (b && "object" == b.name) {
          ...
          if (l.name || l.id) {
            if ("string" == typeof arguments[0]) {
              if (!(new RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)")).test(l.className))
                continue;
            } else if ("function" == typeof arguments[0] && (f = {}, !1 === arguments[0](l, f)))
              continue;
            this.replace(l, f);
          }
        }
      ...
      CKEDITOR.editor.prototype.setMode = function(a, b) {
        ...
        if (a != f.mode && l && l[a]) {
          ...
          if (f.mode) {
            ...
            f._.previousModeData = f.getData(1);
      ...
      function a(a) {
        ...
        if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)
          if (g = f(g, d))
            g.appendBogus(), h = CKEDITOR.env.ie;
      ...
      function m(a) {
        ...
        if (e.startPath().contains(g)) {
          ...
          a.checkBackward();
          if (d)
            return f = e.clone(), f.collapse(), f.setEndAt(d, CKEDITOR.POSITION_AFTER_END), a = new CKEDITOR.dom.walker(f), a.guard = b(!0), d = !1, a.checkForward(), d;
        }
        return null;
      }
      function l(a, b, c) {
        ...
        proto: {
          ...
          insertElementIntoRange: function(a, b) {
            ...
            var f,
                k;
            if (g)
              for (; (f = b.getCommonAncestor(0, 1)) && (k = CKEDITOR.dtd[f.getName()]) && (!k || !k[e]); )
          ...
          extractHtmlFromRange: function(a, b) {
            ...
            if (b) {
              ...
              c.autoParagraph(this.editor, a), v(a.startContainer) && a.startContainer.appendBogus();
              ...
              CKEDITOR.env.webkit && this.attachListener(a, "key", function(b) {
                ...
                if (b in n) {
                  ...
                  if (d.collapsed)
                    ...
                    c = d, f = b.block, d = c.endPath().block, f && d && !f.equals(d) ? (a.fire("saveSnapshot"), (e = f.getBogus()) && e.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(f, !1), b.lastElement.mergeSiblings(), k(f, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
                  if (!b)
                    return;
      ...
      p = function() {
        ...
        function b(c, d) {
          ...
          for (var l = m[l.getName()],
              ...
              w = -1,
              C = 0,
              t = e.contains(m.$list); n < q; ++n)
            e = r.getItem(n), a(e) ? (f = e.getName(), t && f in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (k = !!l[f], "br" != f || !e.data("cke-eol") || n && n != q - 1 || (C = (g = n ? h[n - 1].node : r.getItem(n + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && m.$block[g.getName()]), -1 != p || k || (p = n), k || (w = n), h.push({
              isElement: 1,
              isLineBreak: C,
        ...
        function e(b, c) {
          ...
          for (n && d.push(" "); h < f; h++)
            k = g.getItem(h), a(k) && !k.is(l) ? d = d.concat(e(k, c)) : d.push(k);
          n && d.push(" ");
          return d;
        }
        function g(b) {
        ...
        return function(n, E, p, w) {
          ...
          if (!w.checkReadOnly()) {
            ...
            A = E.startPath();
            if (t = A.contains(f, !1, 1))
              E.splitElement(t), n.inlineStylesRoot = t, n.inlineStylesPeak = A.lastElement;
            A = E.createBookmark();
            (t = A.startNode.getPrevious(c)) && a(t) && f(t) && w.push(t);
            (t = A.startNode.getNext(c)) && a(t) && f(t) && w.push(t);
            for (t = A.startNode; (t = t.getParent()) && f(t); )
              w.push(t);
            E.moveToBookmark(A);
            if (A = p) {
              A = n.range;
              if ("text" == n.type && n.inlineStylesRoot) {
                ...
                for (w = n.inlineStylesRoot.getParent(); !I.equals(w); )
              ...
              if ((N = A.startPath().block) && (1 != N.getChildCount() || !N.getBogus()))
                a: {
                  var P;
              ...
              for (h(E, P); w < E.length; w++) {
                ...
                if (L)
                  ...
                  if (t && v.isElement) {
                    ...
                    if (L)
                      U && (Z = P.splitElement(U), n.zombies.push(Z), n.zombies.push(U));
                    else {
                      U = I.getName();
                      aa = !w;
                      L = w == E.length - 1;
                      ...
                      for (var X = [],
                          ...
                          ia = 0,
                          fa = -1; ea < ba; ea++)
                        ha = U[ea], " " == ha ? (ia || aa && !ea || (X.push(new CKEDITOR.dom.text(" ")), fa = X.length), ia = 1) : (X.push(ha), ia = 0);
                      L && fa == X.length && X.pop();
                      aa = X;
                    }
                  }
            ...
            for (aa = R.createBookmark(); Q = n.zombies.pop(); )
              Q.getParent() && (Y = R.clone(), Y.moveToElementEditStart(Q), Y.removeEmptyBlocksAtEnd());
            if (Z)
              for (; Q = Z.pop(); )
                CKEDITOR.env.needsBrFiller ? Q.appendBogus() : Q.append(R.document.createText(" "));
          ...
          table: function() {
            function a(c) {
              ...
              f.guard = function(a, f) {
                if (a.type == CKEDITOR.NODE_ELEMENT) {
                  ...
                  if (a.getCustomData(m))
                    return;
                  CKEDITOR.dom.element.setMarker(l, a, m, 1);
                }
                if (f && k && a.equals(k))
                  g = c.clone(), g.setEndAt(k, CKEDITOR.POSITION_BEFORE_END), e.push(g);
                else if (!f && h && a.equals(h))
                  g = c.clone(), g.setStartAt(h, CKEDITOR.POSITION_AFTER_START), e.push(g);
                else {
                  if (m = !f)
                    m = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!k || b(a, k)) && (!h || b(a, h));
            ...
            return {
              ...
              detectRanges: function(e, g) {
                ...
                l = l.contains("table");
                if (m || l)
                  m && l && b(m, l) ? (e.tableSurroundingRange = k, k.setStartAt(m, CKEDITOR.POSITION_AFTER_END), k.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), k = f.clone(), k.setEndAt(m, CKEDITOR.POSITION_AFTER_END), h = f.clone(), h.setStartAt(l, CKEDITOR.POSITION_BEFORE_START), h = a(k).concat(a(h))) : m ? l || (e.tableSurroundingRange = k, k.setStartAt(m, CKEDITOR.POSITION_AFTER_END), f.setEndAt(m, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = k, k.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), f.setStartAt(l, CKEDITOR.POSITION_AFTER_START)), e.tableContentsRanges = h ? h : a(f);
              },
      ...
      CKEDITOR.on("instanceCreated", function(b) {
        ...
        d.on("contentDom", function() {
          ...
          if (CKEDITOR.env.ie || u)
            n ? h.attachListener(h, "beforedeactivate", b, null, null, -1) : h.attachListener(d, "selectionCheck", b, null, null, -1), h.attachListener(h, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() {
              d.lockSelection(E);
              q = 1;
          ...
          if (u && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
            ...
            h.attachListener(CKEDITOR.env.ie ? h : e.getDocumentElement(), "mouseup", f, d);
          ...
          var a = n ? function() {
            ...
            var b = function(b, c) {
              ...
              for (var e = d.children,
                  ...
                  n,
                  r; k <= l; )
                if (m = Math.floor((k + l) / 2), g = e[m], h.moveToElementText(g), n = h.compareEndPoints("StartToStart", b), 0 < n)
                  l = m - 1;
                else if (0 > n)
                  k = m + 1;
                else
              ...
              if (-1 == m || m == e.length - 1 && 0 > n) {
                ...
                e = d.childNodes;
                if (!h)
                  return g = e[e.length - 1], g.nodeType != CKEDITOR.NODE_TEXT ? {
                    container: d,
                    offset: e.length
                  } : {
                    container: g,
                ...
                for (d = e.length; 0 < h && 0 < d; )
                  f = e[--d], f.nodeType == CKEDITOR.NODE_TEXT && (r = f, h -= f.nodeValue.length);
                return {
                  container: r,
                  offset: -h
                };
              ...
              if (d == CKEDITOR.SELECTION_ELEMENT) {
                for (var d = [],
                  ...
                  for (var g = c.item(e),
                      f = g.parentNode,
                      h = 0,
                      a = new CKEDITOR.dom.range(this.root); h < f.childNodes.length && f.childNodes[h] != g; h++)
                    ;
          ...
          var b = this,
              c = CKEDITOR.tools.tryThese(function() {
                ...
                for (var a = b.getRanges()[0].clone(),
                    c,
                    d,
                    e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && A[c.getName()] && (d = c)); e--)
          ...
          if (a.length)
            if (this.isLocked) {
              ...
              a: {
                var h,
                    k;
                if (1 == a.length && !(k = a[0]).collapsed && (f = k.getEnclosedNode()) && f.type == CKEDITOR.NODE_ELEMENT && (k = k.clone(), k.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (h = k.getEnclosedNode()) && h.type == CKEDITOR.NODE_ELEMENT && (f = h), "false" == f.getAttribute("contenteditable")))
                  break a;
                f = void 0;
              }
              if (f)
                ...
                if (n) {
                  ...
                  var r,
                      q,
                      p;
                  if ((c = f.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in A && (!c.is("a") || !c.getText()))
                    try {
                  ...
                  for (p = 0; p < a.length; p++) {
                    ...
                    try {
                      ...
                      if (0 <= E.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))
                        f.collapse(1), q.setEnd(f.endContainer.$, f.endOffset);
                      else
                        throw E;
                    }
                    g.addRange(q);
      ...
      function b(c) {
        var d = c.document;
        if (c.collapsed)
          d = r(this, d), c.insertNode(d), c.moveToPosition(d, CKEDITOR.POSITION_BEFORE_END);
        else {
          var g = this.element,
              h = this._.definition,
              k,
          ...
          for (z.getPosition(t) == CKEDITOR.POSITION_FOLLOWING && (z = 0); z; ) {
            ...
            if (z.equals(t))
              ...
              if (x)
                if (B = z.getParent(), x = h, D = g, ea = k, !B || !(B.getDtd() || CKEDITOR.dtd.span)[D] && !ea || x.parentRule && !x.parentRule(B))
                  l = !0;
                else {
                  if (u || A && CKEDITOR.dtd.$removeEmpty[A] && (z.getPosition(t) | K) != K || (u = c.clone(), u.setStartBefore(z)), A = z.type, A == CKEDITOR.NODE_TEXT || v || A == CKEDITOR.NODE_ELEMENT && !z.getChildCount()) {
                    for (var A = z,
                        H; (l = !A.getNext(I)) && (H = A.getParent(), n[H.getName()]) && f(H, p, h, J); )
                      A = H;
                    u.setEndAfter(A);
                  }
                }
              ...
              for (var l = r(this, d),
                ...
                if (y.getName() == g) {
                  for (fa in h.attributes)
                    !D[fa] && (F = y.getAttribute(W)) && (l.getAttribute(fa) == F ? x[fa] = 1 : D[fa] = 1);
                  for (W in h.styles)
                    !B[W] && (F = y.getStyle(W)) && (l.getStyle(W) == F ? A[W] = 1 : B[W] = 1);
                }
                y = y.getParent();
              }
              for (fa in x)
                l.removeAttribute(fa);
              for (W in A)
                l.removeStyle(W);
      ...
      function c(a) {
        ...
        if (a.collapsed) {
          for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root),
              g,
              f = 0,
              h; f < e.elements.length && (h = e.elements[f]) && h != e.block && h != e.blockLimit; f++)
          ...
          b();
          for (e = d; !e.equals(l); )
            g = e.getNextSourceNode(), e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? t.call(this, e) : p(e, u(this)[e.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), e = g;
        }
        a.moveToBookmark(c);
      ...
      function d(a) {
        ...
        for (var d,
            e = a.document,
            g; d = c.getNextParagraph(); )
          !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (g = r(this, e, d), k(d, g));
        a.moveToBookmark(b);
      }
      function h(a) {
        ...
        for (var d,
          ...
          this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), k(d, e)) : t.call(this, d));
        a.moveToBookmark(b);
      }
      function k(a, b) {
        var c = !b;
        ...
        if (d && !e) {
          ...
          f ? b = v(c ? [a.getHtml()] : g(a), b) : a.moveChildren(b);
        b.replace(a);
        if (d) {
          var c = b,
              k;
      ...
      function t(a, b) {
        var c = this._.definition,
            ...
            f;
        for (f in d)
          if ("class" != f && !this._.definition.fullMatch || a.getAttribute(f) == y(f, d[f]))
            b && "data-" == f.slice(0, 5) || (g = a.hasAttribute(f), a.removeAttribute(f));
        for (var h in c)
      ...
      function w(a) {
        for (var b = u(this),
            ...
            d,
            e = c.count(); 0 <= --e; )
          d = c.getItem(e), d.isReadOnly() || t.call(this, d, !0);
        for (var g in b)
          if (g != this.element)
            for (c = a.getElementsByTag(g), e = c.count() - 1; 0 <= e; e--)
              d = c.getItem(e), d.isReadOnly() || p(d, b[g]);
      }
      function p(a, b, c) {
        if (b = b && b.attributes)
      ...
      function x(a, b, c) {
        ...
        for (var g,
            f = e.createIterator(); g = f.getNextRange(); )
          b.call(this, g, c);
        a.selectRanges(e);
              ...
              for (var c = a.elements,
                ...
                if (e = c[d], this.type != CKEDITOR.STYLE_INLINE || e != a.block && e != a.blockLimit) {
                  if (this.type == CKEDITOR.STYLE_OBJECT) {
                    var g = e.getName();
                    if (!("string" == typeof this.element ? g == this.element : g in this.element))
                      continue;
                  }
      ...
      CKEDITOR.dom.elementPath = function(b, e) {
        ...
        do
          if (h.type == CKEDITOR.NODE_ELEMENT) {
            d.push(h);
            if (!this.lastElement && (this.lastElement = h, h.is(CKEDITOR.dtd.$object) || "false" == h.getAttribute("contenteditable")))
              continue;
            if (h.equals(e))
              break;
      ...
      var f = {
        createIterator: function() {
          var a = this,
              ...
              e = [],
              f;
          return {getNextRange: function(l) {
              f = void 0 === f ? 0 : f + 1;
              var d = a[f];
              if (d && 1 < a.length) {
                if (!f)
      ...
      return function(b, c) {
        ...
        var a = function(a) {
          ...
          return this._;
            ...
            e = CKEDITOR.tools.extend({}, CKEDITOR.ui.dialog.uiElement.prototype.eventProcessors, {onChange: function(a, b) {
          ...
          radio: function(b, c, d) {
            if (!(3 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function() {
                for (var a = [],
                    d = [],
                    g = (c.id ? c.id : CKEDITOR.tools.getNextId()) + "_radio",
                    m = 0; m < c.items.length; m++) {
                  var r = c.items[m],
                      z = void 0 !== r[2] ? r[2] : r[0],
                      A = void 0 !== r[1] ? r[1] : r[0],
                      u = CKEDITOR.tools.getNextId() + "_radio_input",
                      y = u + "_label",
                      u = CKEDITOR.tools.extend({}, c, {
                        id: u,
                        title: null,
                        type: null
                      }, !0),
          ...
          select: function(b, c, d) {
            if (!(3 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function() {
                ...
                l(a);
                for (var m = 0,
                    r; m < c.items.length && (r = c.items[m]); m++)
                  f.push('\x3coption value\x3d"', CKEDITOR.tools.htmlEncode(void 0 !== r[1] ? r[1] : r[0]).replace(/"/g, "\x26quot;"), '" /\x3e ', CKEDITOR.tools.htmlEncode(r[0]));
                "undefined" != typeof a.inputStyle && (a.style = a.inputStyle);
            ...
            return function(d, e, f) {
              if (!(3 > arguments.length)) {
                ...
                if (q) {
                  var r = this.focus;
                  this.focus = function() {
                    ("function" == typeof q ? q : r).call(this);
                    this.fire("focus");
                  };
 ...
 while (c = c._.parentDialog);
      ...
      CKEDITOR.dialog = function(b, d) {
        ...
        function r(c) {
          if (x == CKEDITOR.dialog._.currentTop) {
            ...
            if (9 == d || d == CKEDITOR.SHIFT + 9)
              l(d == CKEDITOR.SHIFT + 9 ? -1 : 1), v = 1;
            else if (d == CKEDITOR.ALT + 121 && !x._.tabBarMode && 1 < x.getPageCount())
              x._.tabBarMode = !0, x._.tabs[x._.currentTabId][0].focus(), x._.currentFocusIndex = -1, v = 1;
            else if (-1 != CKEDITOR.tools.indexOf(g, d) && x._.tabBarMode)
              d = -1 != CKEDITOR.tools.indexOf([e ? 39 : 37, 38], d) ? a.call(x) : f.call(x), x.selectPage(d), x._.tabs[d][0].focus(), v = 1;
            else if (13 != d && 32 != d || !x._.tabBarMode)
              if (13 == d)
                d = c.data.getTarget(), d.is("a", "button", "select", "textarea") || d.is("input") && "button" == d.$.type || ((d = this.getButton("ok")) && CKEDITOR.tools.setTimeout(d.click, 0, d), v = 1), y = 1;
              else if (27 == d)
                (d = this.getButton("cancel")) ? CKEDITOR.tools.setTimeout(d.click, 0, d) : !1 !== this.fire("cancel", {hide: !0}).hide && this.hide(), y = 1;
              else
                return;
            else
              this.selectPage(this._.currentTabId), this._.tabBarMode = !1, this._.currentFocusIndex = -1, l(1), v = 1;
            n(c);
          }
        }
        function n(a) {
        ...
        if (b._.removeDialogTabs && (t = b._.removeDialogTabs[d]))
          for (A = 0; A < t.length; A++)
            p.removeContents(t[A]);
        if (p.onLoad)
          this.on("load", p.onLoad);
        if (p.onShow)
          this.on("show", p.onShow);
        if (p.onHide)
          this.on("hide", p.onHide);
        if (p.onOk)
        ...
        this.on("cancel", function(a) {
          B(function(c) {
            if (c.isChanged())
              return b.config.dialog_noConfirmCancel || confirm(b.lang.common.confirmCancel) || (a.data.hide = !1), !0;
          });
        }, this, null, 0);
        ...
        for (A = 0; A < p.contents.length; A++)
          (t = p.contents[A]) && this.addPage(t);
        ...
        CKEDITOR.ui.dialog = {
          uiElement: function(a, b, c, d, e, f, g) {
            if (!(4 > arguments.length)) {
              ...
              for (var p = m["class"] && m["class"].split ? m["class"].split(" ") : [],
                  n = 0; n < p.length; n++)
                p[n] && (q[p[n]] = 1);
              p = [];
              for (n in q)
              ...
              for (n in m)
                k.push(n + '\x3d"' + CKEDITOR.tools.htmlEncode(m[n]) + '" ');
      ...
      CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {openDialog: function(a, b) {
          ...
          if ("function" == typeof d)
            ...
            if ("failed" == d)
              throw t(this), Error('[CKEDITOR.dialog.openDialog] Dialog "' + a + '" failed when loading definition.');
        ...
        exec: function(a) {
          ...
          if (e) {
            ...
            if (b == CKEDITOR.TRISTATE_OFF) {
              ...
              l = [];
              for (h = {}; 0 < d.length; )
                k = d.shift(), e = k.getParent(), k.getPrevious() ? k.getNext() ? (k.breakParent(k.getParent()), l.push(k.getNext())) : k.remove().insertAfter(e) : k.remove().insertBefore(e), e.getCustomData("blockquote_processed") || (l.push(e), CKEDITOR.dom.element.setMarker(h, e, "blockquote_processed", !0)), b.push(k);
              CKEDITOR.dom.element.clearAllMarkers(h);
              ...
              if (a.config.enterMode == CKEDITOR.ENTER_BR)
                for (e = !0; b.length; )
                  if (k = b.shift(), "div" == k.getName()) {
                    ...
                    for (e = k.getNext() && !(k.getNext().type == CKEDITOR.NODE_ELEMENT && k.getNext().isBlockBoundary()); k.getFirst(); )
      ...
      CKEDITOR.plugins.add("blockquote", {init: function(f) {
      ...
      function f(b) {
        ...
        function m(a, c) {
          ...
          if (!d.getById("cke_pastebin")) {
            ...
            (n = r.getParent().isReadOnly()) ? (r.setOpacity(0), r.setAttribute("contenteditable", !0)) : r.setStyle("ltr" == b.config.contentsLangDirection ? "left" : "right", "-10000px");
      ...
      function e() {
        ...
        return {get: function(c) {
            return "plain-text" == c ? b.plainText || (b.plainText = new CKEDITOR.filter("br")) : "semantic-content" == c ? ((c = b.semanticContent) || (c = new CKEDITOR.filter, c.allow({$1: {
                elements: a(),
                attributes: !0,
                styles: !1,
                classes: !1
        ...
        init: function(a) {
          ...
          a.on("paste", function(b) {
            ...
            if (!b.data.dataValue) {
              ...
              if (d)
                b.data.dataValue = d, b.data.type = "html";
      ...
      CKEDITOR.plugins.clipboard = {
        ...
        fixSplitNodesAfterDrop: function(a, b, c, d) {
          function e(a, c, d) {
            ...
            if (f.equals(c) && d != c.getChildCount())
              return a = b.startContainer.getChild(b.startOffset - 1), c = b.startContainer.getChild(b.startOffset), a && a.type == CKEDITOR.NODE_TEXT && c && c.type == CKEDITOR.NODE_TEXT && (d = a.getLength(), a.setText(a.getText() + c.getText()), c.remove(), b.setStart(a, d), b.collapse(!0)), !0;
          }
        ...
        getRangeAtDropPosition: function(a, b) {
          ...
          if (document.caretRangeFromPoint)
            c = b.document.$.caretRangeFromPoint(d, e), h.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), h.collapse(!0);
          else if (c.rangeParent)
            h.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset), h.collapse(!0);
          else {
            if (CKEDITOR.env.ie && 8 < CKEDITOR.env.version && f && b.editable().hasFocus)
              return f;
              ...
              try {
                ...
                if (k) {
                  ...
                  if (B.equals(b.editable()) || "html" == B.getName())
                    return f && f.startContainer && !f.startContainer.equals(b.editable()) ? f : null;
                  D = B.getClientRect();
      ...
      CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
        ...
        _getImageFromClipboard: function() {
          ...
          if (this.$ && this.$.items && this.$.items[0])
            try {
              if ((a = this.$.items[0].getAsFile()) && a.type)
                return a;
            } catch (b) {}
        }
      };
        ...
        proto: {
          ...
          showBlock: function(a, c, e, f, l, d) {
            ...
            var n = this.element,
                ...
                q = w.x + (f || 0) - v.x,
                r = w.y + (l || 0) - v.y;
            !p || 1 != e && 4 != e ? p || 2 != e && 3 != e || (q += c.$.offsetWidth - 1) : q += c.$.offsetWidth;
            if (3 == e || 4 == e)
              r += c.$.offsetHeight - 1;
          ...
          showAsChild: function(a, c, e, f, l, d) {
            if (this._.activeChild != a || a._.panel._.offsetParentId != e.getId())
              this.hideChild(), a.onHide = CKEDITOR.tools.bind(function() {
                CKEDITOR.tools.setTimeout(function() {
      ...
      CKEDITOR.menu = CKEDITOR.tools.createClass({
        ...
        proto: {
          ...
          show: function(b, c, d, e) {
            ...
            a(f);
            for (var t = g.elementPath(),
                t = ['\x3cdiv class\x3d"cke_menu' + (t && t.direction() != g.lang.dir ? " cke_mixed_dir_content" : "") + '" role\x3d"presentation"\x3e'],
                w = f.length,
                p = w && f[0].group,
                q = 0; q < w; q++) {
              var r = f[q];
      ...
      function a(a, b) {
        ...
        a.on("selectionChange", function() {
          ...
          d = d.length;
          for (l = 0; l < d; l++)
            u = f[l], m = a.lang.elementspath.eleTitle.replace(/%1/, u), u = c.output({
              id: n + l,
              label: m,
              text: u,
      ...
      CKEDITOR.plugins.add("elementspath", {init: function(b) {
          b._.elementsPath = {
      ...
      CKEDITOR.plugins.add("indent", {init: function(b) {
          ...
          b.on("dirChanged", function(a) {
            ...
            e.setStartBefore(d);
            e.setEndAfter(d);
            for (var f = new CKEDITOR.dom.walker(e),
                k; k = f.next(); )
      ...
      function a(a) {
        function c(f) {
          for (var h = t.startContainer,
              m = t.endContainer; h && !h.getParent().equals(f); )
            h = h.getParent();
          for (; m && !m.getParent().equals(f); )
            m = m.getParent();
          if (!h || !m)
            return !1;
          for (var p = h,
              h = [],
              w = !1; !w; )
            p.equals(m) && (w = !0), h.push(p), p = p.getNext();
          if (1 > h.length)
            return !1;
          p = f.getParents(!0);
          for (m = 0; m < p.length; m++)
            if (p[m].getName && l[p[m].getName()]) {
              f = p[m];
              break;
            }
          for (var p = e.isIndent ? 1 : -1,
              m = h[0],
              h = h[h.length - 1],
              w = CKEDITOR.plugins.list.listToArray(f, g),
              y = w[h.getCustomData("listarray_index")].indent,
              m = m.getCustomData("listarray_index"); m <= h.getCustomData("listarray_index"); m++)
            if (w[m].indent += p, 0 < p) {
              var v = w[m].parent;
              w[m].parent = new CKEDITOR.dom.element(v.getName(), v.getDocument());
            }
          for (m = h.getCustomData("listarray_index") + 1; m < w.length && w[m].indent > y; m++)
            w[m].indent += p;
          h = CKEDITOR.plugins.list.arrayToList(w, g, null, a.config.enterMode, f.getDirection());
          if (!e.isIndent) {
            var x;
            if ((x = f.getParent()) && x.is("li"))
              for (var p = h.listNode.getChildren(),
                  B = [],
                  D,
                  m = p.count() - 1; 0 <= m; m--)
                (D = p.getItem(m)) && D.is && D.is("li") && B.push(D);
          }
          h && h.listNode.replace(f);
          if (B && B.length)
            for (m = 0; m < B.length; m++) {
              for (D = f = B[m]; (D = D.getNext()) && D.is && D.getName() in l; )
                CKEDITOR.env.needsNbspFiller && !f.getFirst(b) && f.append(t.document.createText(" ")), f.append(D);
              f.insertAfter(x);
            }
      ...
      CKEDITOR.plugins.add("indentlist", {
        ...
        init: function(b) {
          ...
          CKEDITOR.tools.extend(c.prototype, e.specificDefinition.prototype, {context: {
              ol: 1,
              ul: 1
            }});
        }
      ...
      function a(a, b, c) {
        function d(c) {
          if (!(!(l = k[c ? "getFirst" : "getLast"]()) || l.is && l.isBlockBoundary() || !(m = b.root[c ? "getPrevious" : "getNext"](CKEDITOR.dom.walker.invisible(!0))) || m.is && m.isBlockBoundary({br: 1})))
            a.document.createElement("br")[c ? "insertBefore" : "insertAfter"](l);
        }
        for (var e = CKEDITOR.plugins.list.listToArray(b.root, c),
            f = [],
          ...
          for (var g = 0,
            ...
            if ("li" == k.$.nodeName.toLowerCase()) {
              ...
              for (var m = 0,
                  n = k.getChildCount(),
                  t; m < n; m++)
                t = k.getChild(m), t.type == CKEDITOR.NODE_ELEMENT && d[t.getName()] ? CKEDITOR.plugins.list.listToArray(t, b, c, e + 1, l.grandparent) : l.contents.push(t);
            }
          }
          return c;
        },
          ...
          for (var h,
            ...
            if (H.indent == v) {
              ...
              for (h = 0; h < H.contents.length; h++)
                D.append(H.contents[h].clone(1, 1));
              t++;
            } else if (H.indent == Math.max(v, 0) + 1)
              H = a[t - 1].element.getDirection(1), t = CKEDITOR.plugins.list.arrayToList(a, null, t, e, H != F ? F : null), !D.getChildCount() && CKEDITOR.env.needsNbspFiller && 7 >= l.$.documentMode && D.append(l.createText(" ")), D.append(t.listNode), t = t.nextIndex;
              ...
              for (h = 0; h < T; h++)
                if (O = H.contents[h], k(O) && 1 < T)
                  S ? M = O.clone(1, 1) : D.append(O.clone(1, 1));
                  ...
                  S ? (G || (G = l.createElement(I), D.append(G), n && G.setAttribute("dir", F)), E && G.setAttribute("style", E), J && G.setAttribute("class", J), M && (G.append(M), M = null), G.append(O.clone(1, 1))) : D.append(O.clone(1, 1));
              ...
              return null;
            G = null;
            if (a.length <= t || Math.max(a[t].indent, 0) < v)
              break;
          }
          if (b)
            for (a = m.getFirst(); a; ) {
        ...
        exec: function(b) {
          ...
          if (this.state == CKEDITOR.TRISTATE_OFF) {
            ...
            if (k.getFirst(g)) {
              ...
              e.enterMode == CKEDITOR.ENTER_BR ? k.appendBogus() : h[0].fixBlock(1, e.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), f.selectRanges(h);
          }
          for (var e = f.createBookmarks(!0),
              k = [],
              m = {},
              h = h.createIterator(),
              n = 0; (l = h.getNextRange()) && ++n; ) {
            ...
            l = l.createIterator();
            for (l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; t = l.getNextParagraph(); )
              if (!t.getCustomData("list_block")) {
                CKEDITOR.dom.element.setMarker(m, t, "list_block", 1);
                for (var D = b.elementPath(t),
                    x = D.elements,
                    B = 0,
                    D = D.blockLimit,
                    F,
                    G = x.length - 1; 0 <= G && (F = x[G]); G--)
                  if (d[F.getName()] && D.contains(F)) {
          ...
          for (F = []; 0 < k.length; )
            if (x = k.shift(), this.state == CKEDITOR.TRISTATE_OFF)
              if (d[x.root.getName()]) {
                ...
                D = [];
                for (t = 0; t < n.contents.length; t++)
                  G = n.contents[t], (G = G.getAscendant("li", !0)) && !G.getCustomData("list_item_processed") && (D.push(G), CKEDITOR.dom.element.setMarker(x, G, "list_item_processed", !0));
                for (var G = n.root.getDocument(),
                    I = void 0,
                    H = void 0,
                    t = 0; t < D.length; t++) {
                ...
                for (t = 0; t < D && (B = x.listNode.getChild(t)); t++)
                ...
                for (G = 0; G < D.length; G++)
                  l = l.getCommonAncestor(D[G].getParent());
                I = B.config.useComputedState;
                B = x = void 0;
                I = void 0 === I || I;
                for (G = 0; G < D.length; G++)
                  for (H = D[G]; K = H.getParent(); ) {
                    if (K.equals(l)) {
                      n.push(H);
                ...
                if (!(1 > n.length)) {
                  ...
                  t.push(G);
                  for (I = t = void 0; n.length; )
                    t = n.shift(), I = h.createElement("li"), H = t, H.is("pre") || v.test(H.getName()) || "false" == H.getAttribute("contenteditable") ? t.appendTo(I) : (t.copyAttributes(I), x && t.getDirection() && (I.removeStyle("direction"), I.removeAttribute("dir")), t.moveChildren(I), t.remove()), I.appendTo(G);
                  x && B && G.setAttribute("dir", x);
                  D ? G.insertBefore(D) : G.appendTo(l);
                }
              }
            else
              this.state == CKEDITOR.TRISTATE_ON && d[x.root.getName()] && a.call(this, b, x, m);
          for (G = 0; G < F.length; G++)
            c(F[G]);
          ...
          a.blockless || (a.addCommand("numberedlist", new f("numberedlist", "ol")), a.addCommand("bulletedlist", new f("bulletedlist", "ul")), a.ui.addButton && (a.ui.addButton("NumberedList", {
            ...
            if ("wysiwyg" == a.mode && c in {
              ...
              if (h && h.collapsed) {
                ...
                if (t) {
                  var x;
                  (x = k.contains(d)) && h.checkBoundaryOfElement(x, CKEDITOR.START) && (x = x.getParent()) && x.is("li") && (x = l(x)) ? (f = x, x = x.getPrevious(g), c.moveToPosition(x && n(x) ? x : f, CKEDITOR.POSITION_BEFORE_START)) : (C.range.setStartAt(v, CKEDITOR.POSITION_AFTER_START), C.range.setEnd(h.startContainer, h.startOffset), (x = C.previous()) && x.type == CKEDITOR.NODE_ELEMENT && (x.getName() in d || x.is("li")) && (x.is("li") || (C.range.selectNodeContents(x), C.reset(), C.evaluator = e, x = C.previous()), f = x, c.moveToElementEditEnd(f), c.moveToPosition(c.endPath().block, CKEDITOR.POSITION_BEFORE_END)));
                  if (f)
                    m(a, c, h), b.cancel();
                  else {
                    var B = k.contains(d);
                  ...
                  C.range.setEndAt(v, CKEDITOR.POSITION_BEFORE_END), (x = C.next()) && x.type == CKEDITOR.NODE_ELEMENT && x.is(d) && (x = x.getFirst(g), k.block && h.checkStartOfBlock() && h.checkEndOfBlock() ? (k.block.remove(), h.moveToElementEditStart(x), h.select()) : l(x) ? (h.moveToElementEditStart(x), h.select()) : (h = h.clone(), h.moveToElementEditStart(x), m(a, c, h)), b.cancel());
                setTimeout(function() {
                  a.selectionChange(1);
                });
              }
          ...
          if (m = m || f(a)) {
            ...
            if (w && p) {
              if (r && (r.is("li") || r.getParent().is("li"))) {
                ...
                if (A.is("li"))
                  v || u ? (v && u && m.remove(), r[u ? "insertAfter" : "insertBefore"](A)) : r.breakParent(A);
                else {
                  if (a)
                    if (q.block.is("li") ? (A = t.createElement(d == CKEDITOR.ENTER_P ? "p" : "div"), x && A.setAttribute("dir", w), C && A.setAttribute("style", C), p && A.setAttribute("class", p), r.moveChildren(A)) : A = q.block, v || u)
                      A[v ? "insertBefore" : "insertAfter"](m);
                    else
                      r.breakParent(m), A.insertAfter(m);
                  else if (r.appendBogus(!0), v || u)
                    for (; t = r[v ? "getFirst" : "getLast"](); )
                      t[v ? "insertBefore" : "insertAfter"](m);
                  else
                    for (r.breakParent(m); t = r.getLast(); )
                      t.insertAfter(m);
                  r.remove();
                }
                z.selectBookmarks(y);
            ...
            if (w = m.splitBlock(z)) {
              ...
              if (q || a) {
                ...
                if (t = w.elementPath)
                  for (v = 0, z = t.elements.length; v < z; v++) {
                    y = t.elements[v];
                    if (y.equals(t.block) || y.equals(t.blockLimit))
                      break;
                ...
                r.is("li") && (A = m.clone(), A.selectNodeContents(r), A = new CKEDITOR.dom.walker(A), A.evaluator = function(a) {
    ...
    }(), CKEDITOR.config.basicEntities = !0, CKEDITOR.config.entities = !0, CKEDITOR.config.entities_latin = !0, CKEDITOR.config.entities_greek = !0, CKEDITOR.config.entities_additional = "#39", CKEDITOR.plugins.add("popup"), CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {popup: function(a, f, b, c) {
        f = f || "80%";
        b = b || "70%";
      ...
      function m(a, d, g, l) {
        if (l && l.length)
          for (var v,
              t = l.length; t--; )
            if (v = l[t], "hbox" != v.type && "vbox" != v.type && "fieldset" != v.type || m(a, d, g, v.children), v.filebrowser)
                ...
                v.onClick = function(a) {
                  ...
                  if (c.call(b, a)) {
                    ...
                    if (b = new CKEDITOR.dom.element(a.$.form))
                      (a = b.$.elements.ckCsrfToken) ? a = new CKEDITOR.dom.element(a) : (a = new CKEDITOR.dom.element("input"), a.setAttributes({
                        name: "ckCsrfToken",
                        type: "hidden"
      ...
      CKEDITOR.on("dialogDefinition", function(a) {
        if (a.editor.plugins.filebrowser)
          for (var b = a.data.definition,
              c,
              d = 0; d < b.contents.length; ++d)
            if (c = b.contents[d])
              m(a.editor, a.data.name, b, c.elements), c.hidden && c.filebrowser && (c.hidden = !l(b, c.id, c.filebrowser));
      });
    }(), function() {
      function a(a) {
        var e = a.config,
      ...
      CKEDITOR.plugins.add("floatingspace", {init: function(b) {
          b.on("loaded", function() {
            a(this);
          }, null, null, 20);
        }});
      ...
      CKEDITOR.ui.button.prototype = {
        render: function(a, e) {
          ...
          var t = {
            ...
            attach: function(a) {
              ...
              w = CKEDITOR.tools.addFunction(function(a) {
                if (t.onkey)
                  return a = new CKEDITOR.dom.event(a), !1 !== t.onkey(t, a.getKeystroke());
              }),
          ...
          if (this.modes) {
            ...
            k && (k = a.getCommand(k)) && (k.on("state", function() {
        ...
        if (!a.blockless) {
          for (var f = a.config,
            ...
            if (!a.filter.customConfig || a.filter.check(k))
              m++, e[h] = k, e[h]._.enterMode = a.config.enterMode, l.push(k);
          }
      ...
      CKEDITOR.plugins.add("horizontalrule", {init: function(f) {
      ...
      CKEDITOR.plugins.add("image", {
        ...
        init: function(b) {
          if (!b.plugins.image2) {
            ...
            b.addMenuItems && b.addMenuItems({image: {
      ...
      CKEDITOR.plugins.add("link", {
        ...
        afterInit: function(a) {
          ...
          b && b.push(function(b, c) {
            if ("a" == c && (CKEDITOR.plugins.link.tryRestoreFakeAnchor(a, b) || b.getAttribute("name") && (!b.getAttribute("href") || !b.getChildCount())))
              return "anchor";
          });
        }
      });
      ...
      CKEDITOR.plugins.link = {
        ...
        parseLinkAttributes: function(a, b) {
          ...
          if (!C.type)
            if (u = c.match(h))
              C.type = "anchor", C.anchor = {}, C.anchor.name = C.anchor.id = u[1];
            else if (u = c.match(m)) {
              y = c.match(l);
              c = c.match(d);
              C.type = "email";
              ...
              c && (y = c.match(k)) && (C.type = "url", C.url = {}, C.url.protocol = y[1], C.url.url = y[2]);
          if (b) {
        ...
        getLinkAttributes: function(c, d) {
          ...
          if (d.target)
            if ("popup" == d.target.type) {
              for (var e = ["window.open(this.href, '", d.target.name || "", "', '"],
              ...
              "notSet" != d.target.type && d.target.name && (g.target = d.target.name);
          d.download && (g.download = "");
          if (d.advanced) {
            for (var t in p)
              (e = d.advanced[p[t]]) && (g[t] = e);
      ...
      CKEDITOR.removeAnchorCommand.prototype = {
        exec: function(a) {
          var b = a.getSelection(),
              c = b.createBookmarks(),
              d;
          if (b && (d = b.getSelectedElement()) && (d.getChildCount() ? d.is("a") : CKEDITOR.plugins.link.tryRestoreFakeAnchor(a, d)))
            d.remove(1);
      ...
      function b(a) {
        ...
        if (b && n(b) && (b = b.getAscendant(a.triggers, !0)) && a.editable.contains(b)) {
          var c = l(b);
          if ("true" == c.getAttribute("contenteditable"))
            return b;
          if (c.is(a.triggers))
            return c;
        }
      ...
      function p(a, b) {
        if (!b)
          return !1;
        for (var c = b.getParents(1),
            d = c.length; d--; )
          for (var e = a.tabuList.length; e--; )
            if (c[d].hasAttribute(a.tabuList[e]))
              return !0;
        return !1;
      }
      function q(a, b, c) {
      ...
      function z(a) {
        ...
        var g = Math.min(g, 0 | h.size.outerHeight / 2),
            ...
            l,
            p;
        if (m(c.y, h.size.top - 1, h.size.top + g))
          p = !1;
        else if (m(c.y, h.size.bottom - g, h.size.bottom + 1))
          p = !0;
        else
          return null;
        if (v(h) || q(a, h, p) || h.getParent().is(ca))
          return null;
        var r = e(a, h, !p);
        if (r) {
          if (r && r.type == CKEDITOR.NODE_TEXT)
            return null;
          if (n(r)) {
            if (v(r) || !w(a, r) || r.getParent().is(ca))
              return null;
            k = [r, h][p ? "reverse" : "concat"]().concat([S, O]);
          }
        } else
          h.equals(a.editable[p ? "getLast" : "getFirst"](a.isRelevant)) ? (y(a), p && m(c.y, h.size.bottom - g, d.pane.height) && m(h.size.bottom, d.pane.height - g, d.pane.height) ? l = M : m(c.y, 0, h.size.top + g) && (l = T)) : l = V, k = [null, h][p ? "reverse" : "concat"]().concat([p ? E : J, O, l, h.equals(a.editable[p ? "getLast" : "getFirst"](a.isRelevant)) ? p ? M : T : V]);
      ...
      function A(a, b, c, d) {
        for (var e = b.getDocumentPosition(),
            ...
            k = {},
            l = ba.length; l--; )
          f[ba[l]] = parseInt(b.getComputedStyle.call(b, "border-" + ba[l] + "-width"), 10) || 0, h[ba[l]] = parseInt(b.getComputedStyle.call(b, "padding-" + ba[l]), 10) || 0, g[ba[l]] = parseInt(b.getComputedStyle.call(b, "margin-" + ba[l]), 10) || 0;
        c && !d || C(a, d);
            ...
            l.is(H.$inline) || (m.inInlineMode && !t(l) && l.setStyles({
              ...
              if ("wysiwyg" == a.mode)
                if (m.inInlineMode) {
                  ...
                  clearTimeout(u), u = null, m.line.detach();
          ...
          X = function() {
            function b(e) {
              var f = e.element,
                  ...
                  h,
                  k;
              if (!n(f) || f.contains(e.editable) || f.isReadOnly())
                return null;
              k = x(e, function(a, b) {
                return !b.equals(a);
              }, function(a, b) {
              ...
              u(e, g);
              u(e, h);
              if (!m(e.mouse.y, g.size.top, h.size.bottom))
                return null;
              for (var f = Number.MAX_VALUE,
                  l,
                  p,
                  r,
                  t; h && !h.equals(g) && (p = g.getNext(e.isRelevant)); )
                l = Math.abs(c(e, g, p) - e.mouse.y), l < f && (f = l, r = g, t = p), g = p, u(e, g);
              if (!r || !t || !m(e.mouse.y, r.size.top, t.size.bottom))
                return null;
              k.upper = r;
              k.lower = t;
              return k.set(S, 8);
            ...
            a.addCommand("maximize", {
              ...
              exec: function() {
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                  ...
                  for (var q = [p, w],
                      z = 0; z < q.length; z++)
                    c(q[z], q[z].getCustomData("maximize_saved_styles")), q[z].removeCustomData("maximize_saved_styles");
                  for (q = a.container; q = q.getParent(); )
                ...
                this.toggleState();
                if (q = this.uiItems[0])
                  p = this.state == CKEDITOR.TRISTATE_OFF ? d.maximize.maximize : d.maximize.minimize, q = CKEDITOR.document.getById(q._.id), q.getChild(1).setHtml(p), q.setAttribute("title", p), q.setAttribute("href", 'javascript:void("' + p + '");');
          ...
          b.on("paste", function(f) {
            ...
            if (d && (c || h.test(d)) && (!1 !== b.fire("pasteFromWord", k) || c)) {
              ...
              var g = a(b, e, function() {
                if (g)
                  b.fire("paste", l);
                else if (!b.config.pasteFromWordPromptCleanup || c || confirm(b.lang.pastefromword.confirmCleanup))
                  k.dataValue = CKEDITOR.cleanWord(k.dataValue, b), b.fire("afterPasteFromWord", k), l.dataValue = k.dataValue;
                c = 0;
              });
              g && f.cancel();
            }
      ...
      commands: {removeformat: {exec: function(a) {
            for (var f = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")),
                b = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")),
              ...
              var h = d.createBookmark(),
                  ...
                  n = function(b) {
                    for (var d = a.elementPath(b),
                        e = d.elements,
                        g = 1,
                        h; (h = e[g]) && !h.equals(d.block) && !h.equals(d.blockLimit); g++)
              ...
              if (g)
                for (n(g), k = k.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); k && !k.equals(g); )
                  if (k.isReadOnly()) {
                    if (k.getPosition(g) & CKEDITOR.POSITION_CONTAINS)
                      break;
                    k = k.getNext(l);
                  } else
                    n = k.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT), "img" == k.getName() && k.data("cke-realelement") || !c(a, k) || (f.test(k.getName()) ? k.remove(1) : (k.removeAttributes(b), a.fire("removeFormatCleanup", k))), k = n;
              d.moveToBookmark(h);
            }
            a.forceNextSelectionCheck();
    ...
    }, CKEDITOR.config.removeFormatTags = "b,big,cite,code,del,dfn,em,font,i,ins,kbd,q,s,samp,small,span,strike,strong,sub,sup,tt,u,var", CKEDITOR.config.removeFormatAttributes = "class,style,lang,width,height,align,hspace,valign", CKEDITOR.plugins.add("resize", {init: function(a) {
        function f(b) {
          var e = h.width,
              f = h.height,
      ...
      onLoad: function() {
        var a = function(a) {
          var b = this._,
              c = b.menu;
          b.state !== CKEDITOR.TRISTATE_DISABLED && (b.on && c ? c.hide() : (b.previousState = b.state, c || (c = b.menu = new CKEDITOR.menu(a, {panel: {
              className: "cke_menu_panel",
      ...
      addMenuItems: function(a) {
        ...
        a.addCommand("scaytAbout", {exec: function(a) {
            a.scayt.tabToOpen = "about";
            a.lockSelection();
            a.openDialog(f.dialogName);
          }});
        a.addCommand("scaytOptions", {exec: function(a) {
            a.scayt.tabToOpen = "options";
            a.lockSelection();
            a.openDialog(f.dialogName);
          }});
        a.addCommand("scaytLangs", {exec: function(a) {
            a.scayt.tabToOpen = "langs";
            a.lockSelection();
            a.openDialog(f.dialogName);
          }});
        a.addCommand("scaytDict", {exec: function(a) {
      ...
      bindEvents: function(a) {
              ...
              c.attachListener(c, "focus", function(c) {
                ...
                if ((b || c) && a._.savedSelection) {
                  ...
                  for (var l = 0; l < c.length; l++)
                    f = c[l], "string" === typeof f.startContainer.$.nodeValue && (d = f.startContainer.getText().length, (d < f.startOffset || d < f.endOffset) && a.unlockSelection(!1));
                }
              }, this, null, -10);
            },
            l = function() {
        ...
        a.on("beforeSetMode", function(b) {
          if ("source" == b.data) {
            if (b = a.scayt)
              f.destroy(a), a.fire("scaytButtonState", CKEDITOR.TRISTATE_DISABLED);
      ...
      addRule: function(a) {
        var f = CKEDITOR.plugins.scayt,
            ...
            l = function(b) {
              if (a.scayt && (b.hasAttribute(f.options.data_attribute_name) || b.hasAttribute(f.options.problem_grammar_data_attribute)))
                return !1;
            },
            d = function(b) {
              var c = !0;
      ...
      buildSuggestionMenuItems: function(a, f, b) {
        ...
        if (0 < f.length && "no_any_suggestions" !== f[0])
          if (b)
            ...
            for (b = 0; b < f.length; b++)
              h = "grayt_suggest_" + CKEDITOR.plugins.scayt.suggestions[b].replace(" ", "_"), a.addCommand(h, this.createCommand(CKEDITOR.plugins.scayt.suggestions[b], m, l)), a.addMenuItem(h, {
                label: f[b],
                command: h,
                group: "grayt_suggest",
                order: b + 1
          ...
          c.no_scayt_suggest = CKEDITOR.TRISTATE_DISABLED, a.addCommand("no_scayt_suggest", {exec: function() {}}), a.addMenuItem("no_scayt_suggest", {
      ...
      menuGenerator: function(a, f) {
        ...
        if (d && "off" == a.config.scayt_contextCommands)
          return e;
        for (var k in c)
          d && -1 == CKEDITOR.tools.indexOf(m, k.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || (e[k] = "undefined" != typeof c[k].state ? c[k].state : CKEDITOR.TRISTATE_OFF, "function" !== typeof c[k].verification || c[k].verification(a) || delete e[k], a.addCommand(k, {exec: c[k].exec}), a.addMenuItem(k, {
        ...
        this.loadScaytLibrary(a, function(a) {
          ...
          if (m) {
            ...
            try {
              ...
              f.alarmCompatibilityMessage(), delete m.charsToObserve, l = e(m);
            }
            l.subscribe("suggestionListSend", function(a) {
              for (var b = {},
                  c = [],
                  d = 0; d < a.suggestionList.length; d++)
    ...
    }(), CKEDITOR.plugins.sourcearea = {commands: {source: {
          modes: {
            wysiwyg: 1,
            source: 1
          },
          ...
          a.ui.addRichCombo("Styles", {
            ...
            init: function() {
              ...
              for (m = e.length; g < m; g++)
                a = e[g], c = a._name, k = a._.type, k != f && (this.startGroup(b["panelTitle" + String(k)]), f = k), this.add(c, a.type == CKEDITOR.STYLE_OBJECT ? c : a.buildPreview(), c);
              this.commit();
            },
            onClick: function(b) {
              a.focus();
              ...
              b = c[b];
              var d = a.elementPath();
              if (b.group && b.removeStylesFromSameGroup(a))
                a.applyStyle(b);
              else
            ...
            refresh: function() {
              ...
              if (b) {
                for (var d in c)
                  if (c[d].checkApplicable(b, a, a.activeFilter))
                    return;
                this.setState(CKEDITOR.TRISTATE_DISABLED);
              }
            },
          ...
          exec: function(b) {
            if (b.editable().hasFocus) {
              ...
              if (d = (new CKEDITOR.dom.elementPath(c.getCommonAncestor(), c.root)).contains({
                ...
                if (f || a)
                  if (f)
                    f = new CKEDITOR.dom.element(f), c.moveToElementEditStart(f), c.checkStartOfBlock() && c.checkEndOfBlock() || c.selectNodeContents(f);
                  else
                    return !0;
                else {
                  for (var k = d.getAscendant("table").$,
                      f = d.getParent().$.cells,
                      k = new CKEDITOR.dom.element(k.insertRow(-1), b.document),
                      g = 0,
                      n = f.length; g < n; g++)
                    k.append((new CKEDITOR.dom.element(f[g], b.document)).clone(!1, !1)).appendBogus();
      ...
      CKEDITOR.plugins.add("tab", {init: function(e) {
      ...
      for (var b = void 0 === f ? this.getTabIndex() : f,
          c,
          e,
          m,
          l = 0,
          d,
          h = this.getDocument().getBody().getLast(); h = h.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT); ) {
        if (!c)
          if (!e && h.equals(this)) {
            if (e = !0, a) {
      ...
      init: function(a) {
        ...
        if (!a.blockless) {
          ...
          a.addCommand("tableDelete", f({exec: function(a) {
      ...
      function a(a) {
        ...
        for (var c = [],
          ...
          var f = a[e];
          if (f.collapsed)
            f = f.getCommonAncestor(), (f = f.getAscendant("td", !0) || f.getAscendant("th", !0)) && c.push(f);
          else {
      ...
      function b(c) {
        if (c instanceof CKEDITOR.dom.selection) {
          ...
          for (var d = d[d.length - 1],
              g = d.getParent().$.rowIndex + d.$.rowSpan - 1,
              d = [],
              h = c; h <= g; h++) {
            for (var k = f[h],
                l = new CKEDITOR.dom.element(e.$.rows[h]),
                m = 0; m < k.length; m++) {
      ...
      function e(b, d) {
        ...
        for (l = 0; l < k; l++)
          f[l] && (1 < f[l].colSpan && e[l] == f[l] ? (g = f[l], g.colSpan += 1) : (g = (new CKEDITOR.dom.element(f[l])).clone(), g.removeAttribute("colSpan"), g.appendBogus(), g[d ? "insertBefore" : "insertAfter"].call(g, new CKEDITOR.dom.element(f[l])), g = g.$), l += g.rowSpan - 1);
      }
      function m(a, b) {
      ...
      function l(b) {
        if (b instanceof CKEDITOR.dom.selection) {
          ...
          b instanceof CKEDITOR.dom.element && (c = b.getParent(), 1 == c.getChildCount() ? c.remove() : b.remove());
      }
      function d(a, b) {
        var c = a.getDocument(),
            d = CKEDITOR.document;
      ...
      function h(a, b, c) {
        ...
        for (b = 0; a && b < a.length; b++) {
          if (c.is && a[b] == c.$)
            return b;
          if (b == c)
            return new CKEDITOR.dom.element(a[b]);
        }
        return c.is ? -1 : null;
      }
      function k(b, c, d) {
        var e = a(b),
            f;
        if ((c ? 1 != e.length : 2 > e.length) || (f = b.getCommonAncestor()) && f.type == CKEDITOR.NODE_ELEMENT && f.is("table"))
          return !1;
        var g;
        b = e[0];
      ...
      function g(b, c) {
        ...
        if (1 < m) {
          ...
          for (m = n = 1, f = e.clone(), f.insertAfter(e), f.append(e = d.clone()), v = h(g, k), l = 0; l < v.length; l++)
            v[l].rowSpan++;
        e.appendBogus();
        d.$.rowSpan = n;
        e.$.rowSpan = m;
      ...
      function n(b, c) {
        ...
        var d = d[0],
            ...
            k = d.$.colSpan;
        if (1 < k)
          e = Math.ceil(k / 2), k = Math.floor(k / 2);
        else {
          for (var k = e = 1,
              l = [],
              m = 0; m < f.length; m++) {
        ...
        init: function(c) {
          ...
          p("columnDelete", h({
            ...
            exec: function(b) {
              ...
              for (var f = CKEDITOR.tools.buildTableMap(b),
                  g,
                  h,
                  k = [],
                  l = 0,
              ...
              for (l = g; l <= h; l++)
                for (n = 0; n < f.length; n++)
                  e = f[n], c = new CKEDITOR.dom.element(b.$.rows[n]), e = new CKEDITOR.dom.element(e[l]), e.$ && (1 == e.$.colSpan ? e.remove() : --e.$.colSpan, n += e.$.rowSpan - 1, c.$.cells.length || k.push(c));
      ...
      for (var f = -1,
        ...
        for (var e = -1,
          ...
          for (e++; b[f][e]; )
            e++;
          for (var d = isNaN(l.colSpan) ? 1 : l.colSpan,
              l = isNaN(l.rowSpan) ? 1 : l.rowSpan,
              h = 0; h < l; h++) {
            b[f + h] || (b[f + h] = []);
            for (var k = 0; k < d; k++)
              b[f + h][e + k] = a[c].cells[m];
          }
          e += d - 1;
        }
      }
      ...
      function a(a) {
        ...
        function d(b, c) {
          if (c.length) {
            ...
            for (var d; d = c.shift(); )
              d = "string" == typeof d ? d : d.name, k && -1 != CKEDITOR.tools.indexOf(k, d) || (d = a.ui.create(d)) && a.addFeature(d) && b.items.push(d);
          }
        }
        function h(a) {
          var b = [],
                  ...
                  case CKEDITOR.SHIFT + 9:
                    for (; !c || !c.items.length; )
                      if (c = 9 == b ? (c ? c.next : a.toolbar.next) || e.toolbox.toolbars[0] : (c ? c.previous : a.toolbar.previous) || e.toolbox.toolbars[e.toolbox.toolbars.length - 1], c.items.length)
                        for (a = c.items[f ? c.items.length - 1 : 0]; a && !a.focus; )
 ...
 while (c && !c.focus);
            ...
            if (c.data.space == e.config.toolbarLocation) {
              ...
              for (var v = e.toolbox.toolbars,
                ...
                var q,
                    ...
                    y;
                if (A)
                  if (g && (k.push("\x3c/span\x3e"), m = g = 0), "/" === A)
                    k.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e');
                  else {
                    y = A.items || A;
          ...
          e.ui.addHandler(CKEDITOR.UI_SEPARATOR, {create: function() {
      ...
      CKEDITOR.plugins.add("undo", {init: function(c) {
          function e(a) {
        ...
        update: function(a) {
          if (!this.locked) {
            ...
            for (var b = this.index,
                e = this.snapshots; 0 < b && this.currentImage.equalsContent(e[b - 1]); )
              --b;
        ...
        equalsSelection: function(a) {
          ...
          if (b || a) {
            ...
            for (var c = 0; c < b.length; c++) {
              var e = b[c],
                  f = a[c];
              if (e.startOffset != f.startOffset || e.endOffset != f.endOffset || !CKEDITOR.tools.arrayCompare(e.start, f.start) || !CKEDITOR.tools.arrayCompare(e.end, f.end))
                return !1;
            }
          }
          return !0;
      ...
      m.prototype = {
        ...
        attachListeners: function() {
          ...
          c.attachListener(c, "keydown", function(a) {
            e.onKeydown(a);
            if (b.ieFunctionalKeysBug(a.data.getKey()))
              e.onInput();
          }, null, null, 999);
      ...
      function f(a) {
        ...
        if (CKEDITOR.env.gecko)
          ...
          CKEDITOR.env.ie && 11 > CKEDITOR.env.version && a.config.disableObjectResizing && b(a);
      }
      function b() {
        var a = [];
