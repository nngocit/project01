...
var HeaderRowComp = (function(_super) {
  ...
  HeaderRowComp.prototype.isUsingOldHeaderRenderer = function(column) {
    ...
    return utils_1.Utils.anyExists([this.gridOptionsWrapper.getHeaderCellTemplateFunc(), this.gridOptionsWrapper.getHeaderCellTemplate(), colDef.headerCellTemplate, colDef.headerCellRenderer, this.gridOptionsWrapper.getHeaderCellRenderer()]);
  };
