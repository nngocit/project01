...
NumberFilter.EQUALS = 'equals';
NumberFilter.NOT_EQUAL = 'notEqual';
NumberFilter.LESS_THAN = 'lessThan';
NumberFilter.LESS_THAN_OR_EQUAL = 'lessThanOrEqual';
NumberFilter.GREATER_THAN = 'greaterThan';
NumberFilter.GREATER_THAN_OR_EQUAL = 'greaterThanOrEqual';
NumberFilter.IN_RANGE = 'inRange';
__decorate([context_1.Autowired('context'), __metadata("design:type", context_1.Context)], NumberFilter.prototype, "context", void 0);
