...
var GridOptionsWrapper = GridOptionsWrapper_1 = (function() {
  ...
  GridOptionsWrapper.prototype.isSuppressRowHoverClass = function() {
    return isTrue(this.gridOptions.suppressRowHoverClass);
  };
  ...
  GridOptionsWrapper.prototype.setProperty = function(key, value) {
    ...
    this.propertyEventService.dispatchEvent(key, {
      currentValue: value,
